/* ==========================================================
   ...
   追加: CCTV_Audio_* 全7本（⑦まで収録）
   追加: Personnel_Status.txt / CCTV_AUDIO_INDEX.txt
...
`
        ...
        /* ---------- CCTV_Audio_0001周辺：上記⑦で収録 ---------- */

        /* ---------- 0001周辺：秘匿アーカイブの存在を示す記録 ---------- */

        {
            name:"CCTV_Audio_0001_Archive.txt",
            permission:"platinum",
            relatedStaff:["0001"],
            content:
`
...
[RECORDING INTERRUPTED]
`,
            // この記録を最後まで読むことで「秘匿アーカイブ」の存在を発見する。
            unlocksArchive:"secret"
        },

        /* ---------- 人員状況 ---------- */

        {
            name:"Personnel_Status.txt",
            permission:"platinum",
            content:
`
[PERSONNEL STATUS]
UPDATE: 2016/01/06 03:02:18
...
0000
STATUS: ACTIVE
LAST STATUS UPDATE: 2016/01/06 03:01:17
UPDATED BY: [UNRESOLVED]

[NOTE]
Status source could not be identified.
`
        },
...
STATUS:
01-06  PARTIAL RECORDING
07     PARTIAL RECORDING

NOTE:
Audio source and speaker identification are not guaranteed.
Only explicitly identified personnel are linked to Staff Database records.
`
        },
